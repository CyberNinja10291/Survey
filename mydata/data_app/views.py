...
def submit_data(request):
    ...
    if request.method == 'POST':
        ...
        startpoint_form = StartPointForm(request.data, request.FILES)
        endpoint_form = EndPointForm(request.data, request.FILES)
        ...
        mediafile_form = MediaFileForm(request.data, request.FILES)
